"""lwlrap calculation."""
# got code from https://colab.research.google.com/drive/1AgPdhSp7ttY18O3fEoHOQKlt_3HJDLi8#scrollTo=IHIGP6A9ogyb
import numpy as np
...
def calculate_per_class_lwlrap(truth, scores):
    ...
    Arguments:
        truth: np.array of (num_samples, num_classes) giving boolean ground-truth of presence of that class in that
        sample.
        scores: np.array of (num_samples, num_classes) giving the classifier-under-test's real-valued score for each
